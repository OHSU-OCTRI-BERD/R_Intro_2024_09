...
2.  Download folder `berd_r_intro_2024_09` from Google drive using link <https://bit.ly/berd_intro_2024_files>
...
3.  Open the slides file (html) in a web browser: `slides_R_berd_2024.html`
...
![[Artwork from "Hello, Quarto" keynote by Julia Lowndes and Mine Çetinkaya-Rundel, presented at RStudio Conference 2022. Illustrated by Allison Horst.](https://allisonhorst.com/cetinkaya-rundel-lowndes-quarto-keynote)](image/horst_quarto_moon_penguins.png){fig-align="center"}
...
[^1]: Grolemund, Garrett. 2014. Hands-on Programming with R. O’Reilly. <https://rstudio-education.github.io/hopr/>
...
-   **Reproducible Reports with R Markdown** 2019/09/25
    -   slides: [bit.ly/berd_rmd](http://bit.ly/berd_rmd)
    -   pdf: [bit.ly/berd_rmd_pdf](http://bit.ly/berd_rmd_pdf) - [recording of the presentation](https://echo360.org/media/b082e803-0677-445f-9688-f96b9c36dc93/public)
